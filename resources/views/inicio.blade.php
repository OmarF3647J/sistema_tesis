...
<div class="carrusel_portadas">
  ...
  <a href="{{ route('centro.show', $centro->idcentur) }}">

    <img src="{{ asset($centro->imgcentur ?? 'images/noimage.jpg') }}">
...
<a href="{{ route('centro.show', $centro->idcentur) }}">
  ...
  <div class="grid-item"
       style="background-image: url('{{ asset($centro->imgcentur ?? 'images/noimage.jpg') }}');">
